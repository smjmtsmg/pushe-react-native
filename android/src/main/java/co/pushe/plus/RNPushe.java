...
import static co.pushe.plus.utils.RNPusheUtils.*;
...
public class RNPushe extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    PusheInAppMessaging pusheInApp;
    ...
    @ReactMethod
    public void geAdvertisingId(final Promise promise) {
    ...
    @ReactMethod
    public void triggerEvent(String name, final Promise promise) {
        pusheInApp.triggerEvent(name);
        promise.resolve(true);
    }

    @ReactMethod
    public void enableInAppMessaging(final Promise promise) {
        pusheInApp.enableInAppMessaging();
        promise.resolve(true);
    }

    @ReactMethod
    public void disableInAppMessaging(final Promise promise) {
        pusheInApp.disableInAppMessaging();
        promise.resolve(true);
    }

    @ReactMethod
    public void isInAppMessagingEnabled(final Promise promise) {
        promise.resolve(pusheInApp.isInAppMessagingEnabled());
    }

    @ReactMethod
    public void dismissShownInApp(final Promise promise) {
        pusheInApp.dismissShownInApp();
        promise.resolve(true);
    }

    @ReactMethod
    public void testInAppMessage(String message, Boolean instant, final Promise promise) {
        pusheInApp.testInAppMessage(message, instant);
        promise.resolve(true);
    }

    private void initializeInAppMessagingCallbacks() {
        pusheInApp.setInAppMessagingListener(new PusheInAppMessagingListener() {
            @Override
            public void onInAppMessageReceived(@NonNull InAppMessage inAppMessage) {
                sendCallbackEvent(EVENTS_TYPES.PIAM_RECEIVED.getBroadcast(), inAppMessagingToWritableMap(inAppMessage));
            }

            @Override
            public void onInAppMessageTriggered(@NonNull InAppMessage inAppMessage) {
                sendCallbackEvent(EVENTS_TYPES.PIAM_TRIGGERED.getBroadcast(), inAppMessagingToWritableMap(inAppMessage));
            }

            @Override
            public void onInAppMessageClicked(@NonNull InAppMessage inAppMessage) {
                sendCallbackEvent(EVENTS_TYPES.PIAM_CLICKED.getBroadcast(), inAppMessagingToWritableMap(inAppMessage));
            }

            @Override
            public void onInAppMessageDismissed(@NonNull InAppMessage inAppMessage) {
                sendCallbackEvent(EVENTS_TYPES.PIAM_DISMISSED.getBroadcast(), inAppMessagingToWritableMap(inAppMessage));
            }

            @Override
            public void onInAppMessageButtonClicked(@NonNull InAppMessage inAppMessage, int i) {
                WritableMap map = inAppMessagingToWritableMap(inAppMessage);
                map.putInt("index", i);
                sendCallbackEvent(EVENTS_TYPES.PIAM_BUTTON.getBroadcast(), map);
            }
        });
    }
